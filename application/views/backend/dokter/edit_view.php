<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="<?= base_url('dokter/edit/' . $dokter->id_dokter) ?>" method="POST" class="col-lg-8">
                ...
                <div class="form-group">
                    ...
                    <select name="id_poli" class="form-control">
                        ...
                        <?php foreach ($poli as $p) : ?>
                            <option value="<?= $p->id_poli; ?>" <?= ($p->id_poli == $dokter->id_poli) ? 'selected' : ''; ?>>
                                <?= $p->nama_poli; ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="no_telepon_dokter" class="form-control" value="<?= $dokter->no_telepon_dokter; ?>">
